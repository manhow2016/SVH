...
import { CheckCircleFilled, CrownOutlined, MinusCircleOutlined } from "@ant-design/icons";
...
/**
 * 会员中心内容（顶栏弹窗与 /#/membership 页面共用）：当前等级 / 订阅状态 /
 * 可使用功能 / 升级套餐（活动价）。
 */
      ...
      <Skeleton active loading={loading || plansLoading} paragraph={{ rows: 8 }}>
        ...
        <section style={{ marginTop: 24 }}>
          {membership?.isAdmin ? (
            ...
            >
              管理员账户默认拥有<b>最高使用权限</b>：全部软件功能可用，无需开通会员订阅。
            </div>
          ) : (
            <>
